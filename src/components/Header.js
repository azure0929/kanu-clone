            ...
            <li className="cnb-search-bt flex-1">
              <a href="#none">
                <svg
                  ...
                  width="24"
                  height="24"
                  viewBox="0 0 24 24" // 수정: viewbox → viewBox
                  fill="none"
                >
                  <path
                    d="M11 19C15.4183 19 19 15.4183 19 11C19 6.58172 15.4183 3 11 3C6.58172 3 3 6.58172 3 11C3 15.4183 6.58172 19 11 19Z"
                    stroke="#BE8354"
                    strokeWidth="1.4" // 수정: stroke-width → strokeWidth
                    strokeLinecap="round" // 수정: stroke-linecap → strokeLinecap
                    strokeLinejoin="round" // 수정: stroke-linejoin → strokeLinejoin
                  ></path>
                  <path
            ...
            <li className="xans-element- xans-layout xans-layout-orderbasketcount flex-1">
              <a href="#none" className="relative">
                <svg
                  ...
                  width="22"
                  height="24"
                  viewBox="0 0 22 24" // 수정: viewbox → viewBox
                  fill="none"
                >
                  <path
                ...
                <span className="coupon-label absolute top-[-8px] -right-full text-sm font-medium text-[#BE8354] w-6">0</span>
              </a>
            </li>
          </ul>
        </nav>
