...
function Header() {
  return (
    <header
      id="cnb-header"
      className="cnb-header fixed left-0 top-0 w-full text-[#BE8354] text-[15px] z-50"
    >
      <div className="cnb-header-bg relative">
        <nav className="cnb-header-inner mt-2 min-w-[1340px] max-w-[1340px] w-full mx-auto flex py-5 px-[30px] pr-[50px] bg-[#111] backdrop-blur rounded-2xl z-[1] transition-all duration-500">
          <h1 className="w-[90px]">
            <a href="/">
              <img src="https://kanu.co.kr/SkinImg/img/logo.png" alt="" />
            </a>
          </h1>
          <ul className="cnb-menu-list ml-12 flex gap-11 font-medium">
            <li className="py-1">
              <a
                href="#none"
                className="p-1 py-2 relative after:absolute after:bottom-0 after:left-0 after:bg-[#FFA257] after:w-0 after:h-[1px] hover:after:w-full after:transition-all ease-in hover:text-[#FFA257]"
              >
                머신
              </a>
            </li>
          ...
          <ul className="ml-auto flex gap-6 items-center">
            <li className="cnb-search-bt flex-1">
              <a href="#none">
                <svg
            ...
            <li className="flex-1">
              <a
                href="#none"
                className="xans-element- xans-layout xans-layout-statelogoff"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
            ...
            <li className="xans-element- xans-layout xans-layout-orderbasketcount flex-1">
              <a href="#none" className="relative">
                ...
                <span className="coupon-label absolute top-[-8px] -right-full text-sm font-medium text-[#BE8354] w-6">
                  0
                </span>
              </a>
            </li>
